...
word = [lemmatizer.lemmatizer(word) for word in words if word not in ignore_letters]
...
hist=model.fit(np.array(train_x),np.array(train_y),epochs=200,bath_size=5, verbose=1)
